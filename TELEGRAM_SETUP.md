...
একই bot এখন আপনার **AI assistant**-ও! Bot token সেট করে সার্ভার চালু করলেই, আপনার bot-কে Telegram-এ মেসেজ করলেই **আপনার নিজের AI উত্তর দেবে** (ফোন থেকেই!)। 

- `/start` — ওয়েলকাম
- `/help` — কী কী করতে পারে
- যেকোনো মেসেজ → আপনার AI brain (memory, knowledge, math সব কাজ করে)

এটা long-polling পদ্ধতিতে চলে, তাই কোনো webhook URL লাগে না — Render-এ deploy করলেই সরাসরি কাজ করবে।
